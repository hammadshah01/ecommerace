...
if(mysqli_num_rows($result)){
  ...
  $_SESSION['uemail']=$row['email'];
      header("location:http://localhost/Ecom/front/index.php");
  }

}else{
  echo "<p class='alert alert-danger'>Please Enter valid credentials</p> ";
}
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">E Commerace</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" novalidate>
