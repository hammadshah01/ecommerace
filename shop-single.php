...
price,	
title,	
c_img) VALUES ({$num},'{$quan}','{$price}','{$title}','{$img}'";
...
<body>
 ...
 ?>
        ...
        $id = $_GET['id'];
include 'config.php';
$sql1 = "SELECT * FROM product LEFT JOIN categories ON product.p_category = cat_id LEFT JOIN brands ON product.p_brand = brands.brand_id WHERE p_id={$id}";
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="../admin/upload/<?php echo $row['p_img']?>" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="h3 py-2" id="price"><?php echo $row['p_price'] ?>$</p>
                            <p class="py-2">
                                ...
                                <span class="list-inline-item text-dark">&nbsp <?php echo $row['rating']?></span>
                            </p>
                            ...
                            <form action="buy.php" method="POST">
                                <input hidden name="product-number" value="<?php echo $row['p_id'] ?>">
                                <input type="hidden" name="product-title" value="<?php echo $row['p_name']?>">
                                <input type="hidden" name="img" value="<?php echo $row['p_img']?>">
                                ...
                                <div class="row pb-3">
                                    <div class="col-4 d-grid">
                                        <button type="submit" class="btn btn-success btn-lg" name="submit-log" value="buy">Buy</button>
                                    </div>
...
<script>
    ...
    var finalresult = parseInt($("#price").html());
    $('#btn-minus').click(function () {
        ...
        if (val == '1') {
            ...
            finalresult = finalresult - price;
            $("#price").html(finalresult +'$');
        }
    ...
    $('#btn-plus').click(function () {
        ...
        finalresult = finalresult + parseInt(price);
